        ...
        return (
          ...
          >
            <div className="lg:w-[40%] w-full text-left space-y-6">
              ...
              <h1 className="text-4xl font-extrabold text-gray-900 italic">{project.Pname}</h1>
              <h3 className="text-lg text-gray-600 italic font-bold">{project.Pdes}</h3>
              <p className="text-md text-gray-700">{project.Pinfo}</p>
            </div>

            <div className="lg:w-[80%] w-full flex flex-col gap-6">
              {(Array.isArray(project.Pimg) ? project.Pimg : [project.Pimg]).map((img, imgIndex) => (
