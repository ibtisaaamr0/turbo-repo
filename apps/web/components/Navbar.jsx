...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed w-full z-50  px-5 py-3 flex justify-between items-center rounded-full 
        ...
        <div>
          ...
          <ul className=" lg:flex lg:flex-row lg:justify-between gap-10 xl:gap-60 lg:gap-20 text-gray-300 font-medium bg-linear-to-b from-gray-900 to-gray-500 rounded-full py-4 md:px-10  shadow-lg shadow-r-xl hidden md:text-2xl md:font-bold md:max-w-4xl md:gap-5     ">
            <li>
              <Link href={"/"}>Home</Link>
            </li>
            <li>
      ...
      {Up &&
        (
          <div className='flex flex-col justify-center items-center lg:hidden '>
            <ul className="animate-dropup fixed flex flex-col justify-center items-center 
  bottom-5 bg-gradient-to-t from-gray-900 to-black text-white max-w-sm rounded-4xl 
  gap-10 text-base font-bold w-[90%] sm:max-w-md md:max-w-lg p-4 md:p-10 
  z-[9999]">
